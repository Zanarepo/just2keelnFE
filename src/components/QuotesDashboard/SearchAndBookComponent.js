...
const CleanerSearch = () => {
  ...
  <h2 className="text-2xl font-bold text-green-600 mb-4 text-center mt16">Find a Cleaner</h2>
  ...
  <button
    ...
    className="w-full sm:w-auto px-4 py-2 text-white bg-green-600 rounded-lg hover:bg-green-700 mt-4 sm:mt-6 mx-auto sm:mx-0"
  >
    Search Cleaners
  </button>

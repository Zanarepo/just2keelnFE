  ...
  return (
    <div className="px-4 py-8 bg-white-50">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="w-full aspect-square p-4 bg-white border border-gray-300 rounded-lg shadow-md flex flex-col items-center">
          <div className="text-green-700 text-3xl mb-3 flex items-center justify-center">
            <FaDollarSign />
          </div>
        ...
        <div className="w-full aspect-square p-4 bg-white border border-gray-300 rounded-lg shadow-md flex flex-col items-center">
          ...
          <h3 className="text-lg font-semibold mb-1">Pre-Subscribe</h3>
          <p className="text-sm text-gray-600 text-center">
        ...
        <div className="w-full aspect-square p-4 bg-white border border-gray-300 rounded-lg shadow-md flex flex-col items-center">
          ...
          <h3 className="text-lg font-semibold mb-1">Schedule Your Cleaning</h3>
          <p className="text-sm text-gray-600 text-center">
        ...
        <div className="w-full aspect-square p-4 bg-white border border-gray-300 rounded-lg shadow-md flex flex-col items-center">
          ...
          <h3 className="text-lg font-semibold mb-1">Get Matched with a Cleaner</h3>
          <p className="text-sm text-gray-600 text-center">
